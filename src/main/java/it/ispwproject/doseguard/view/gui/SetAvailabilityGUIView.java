...
public class SetAvailabilityGUIView extends PageGUIView {
    ...
    public SetAvailabilityGUIView() {
        ...
        startTimeField.setPrefWidth(300);
    ...
    public BorderPane buildRoot(Runnable onBack) {
        ...
        Label subtitle   = sectionLabel("Aggiungi un nuovo slot per le visite");
        ...
        centerWrapper.getStyleClass().add("doseguard-background");
