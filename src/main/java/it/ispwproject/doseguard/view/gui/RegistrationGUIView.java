...
public class RegistrationGUIView {
    ...
    public RegistrationGUIView() {
        ...
        pharmacyNameField.setPrefWidth(270);

        pharmacyNameField.setPrefHeight(30);
    ...
    public ScrollPane buildRoot(Runnable onBack) {
        ...
        pharmacistSection = buildPharmacistSection();

        pharmacistSection.setVisible(false);

        pharmacistSection.setManaged(false);
        ...
        root.getChildren().addAll(header, title, logoView, form, doctorSection, pharmacistSection, errorLabel, registerBtn);
    ...
    private void bindRoleRadios() {
        ...
        pharmacistRadio.setOnAction(e -> {
            ...
            pharmacistSection.setVisible(true);

            pharmacistSection.setManaged(true);
    ...
    private VBox buildDoctorSection() {
        ...
        section.setPrefWidth(EXTRA_SECTION_WIDTH);

        section.setMaxWidth(EXTRA_SECTION_WIDTH);
    ...
    private VBox buildPharmacistSection() {
        ...
        section.getChildren().addAll(
                ...
                fieldLabel("Nome Farmacia *"), pharmacyNameField);
