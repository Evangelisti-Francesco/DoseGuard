...
public abstract class DashboardGUIView {
    ...
    public HBox buildNavbar(String ruoloText, Runnable onLogout) {
        ...
        Image logoImg = new Image(
                getClass().getResourceAsStream("/icons/Brand_logo.png"), 80, 80, true, true);
    ...
    public VBox buildCalendarSection(Runnable onPrev, Runnable onNext,
        ...
        Label title = new Label("Calendario Assunzioni / Visite");
    ...
    public void addMonthRow(Pane pane, LocalDate firstDay, int colW) {
        ...
        lbl.setLayoutX(LABEL_WIDTH);
        lbl.setLayoutY(8);
        lbl.setPrefWidth(DAYS * colW);
    ...
    public void addDayHeaders(Pane pane, LocalDate firstDay, LocalDate today, int colW) {
        for (int d = 0; d < DAYS; d++) {
            ...
            dayAbbr.setLayoutX(x);
            dayAbbr.setLayoutY(32);
            dayAbbr.setPrefWidth(colW);
            dayAbbr.setAlignment(Pos.CENTER);
            ...
            if (isToday) {
                ...
                num.setLayoutX(x);
                num.setLayoutY(HEADER_H - 28);
                num.setPrefWidth(colW);
    ...
    public void addHourRows(Pane pane, int totalHours, int colW, int gridHeight) {
        ...
        sep.setLayoutX(LABEL_WIDTH);
        sep.setLayoutY(HEADER_H);
        ...
        for (int h = 0; h < totalHours; h++) {
            ...
            lbl.setPrefWidth(LABEL_WIDTH - 4);
        ...
        for (int d = 1; d < DAYS; d++) {
            ...
            vLine.setLayoutX(LABEL_WIDTH + d * colW);
    ...
    public HBox buildEmailRow(User user, Consumer<String> onSave) {
        ...
        editBtn.setOnAction(e -> {
            viewRow.setVisible(false);
            viewRow.setManaged(false);
