...
public final class CLIRenderer {
    ...
    public static final String AVAIL   = "○";   // slot orario disponibile
    public static final String BOOKED  = "●";   // appuntamento prenotato
    public static final String PENDING = "◌";   // farmaco da assumere
    public static final String DONE    = "◉";   // farmaco assunto
