...
import it.ispwproject.doseguard.view.cli.DashboardPharmacistView;

public class DashboardPharmacistCLI extends AbstractCLIState {

    private final DashboardPharmacistView view = new DashboardPharmacistView();
    ...
    public void action(CLIStateMachine context) {
        ...
        switch (view.chiediScelta()) {
            case "1" -> goNext(context, new ViewPrescriptionsCLI());
            case "0" -> {
                try {
